...
from modules.logistics.pso_logistics_map.pso.discrete_particle import (
    DiscreteParticle,
)
from modules.logistics.pso_logistics_map.pso.operators import (
    apply_random_ops,
    move_toward,
)
...
class DiscreteSwarm:
    ...
    def __init__(
        ...
        """
        Args:
            config  : full map logistics PSO configuration
    ...
    def run(
        ...
        Returns final summary dict (same shape as finished signal).
        """
