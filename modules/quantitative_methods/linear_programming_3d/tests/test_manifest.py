"""Manifest validation tests for linear_programming_3d module."""
...
class TestManifest:
    ...
    def test_id_value(self, manifest: dict) -> None:
        assert manifest["id"] == "linear_programming_3d"
    ...
    def test_entry_point_format(self, manifest: dict) -> None:
        ...
        assert ":" in ep
        assert ep.startswith("modules.quantitative_methods.linear_programming_3d.")
    ...
    def test_optional_dependencies(self, manifest: dict) -> None:
        assert "optional_dependencies" in manifest
        assert "scipy" in manifest["optional_dependencies"]
